...
def _remove_tool_calls(content: Union[str, list[Union[str, dict]]]) -> Union[str, list[Union[str, dict]]]:
...
async def _process_stream_event(event: StreamEvent, user_input: Union[StreamInput, ToolCallApproval], run_id: str) -> AsyncGenerator[str, None]:
...
@app.post("/auth")
async def auth(consent_auth_body: ConsentAuthBody, response: Response) -> AuthResponse:
    """ 
